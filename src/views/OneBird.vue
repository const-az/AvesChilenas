    ...
    <v-container class="py-5">
      ...
      <v-row class="mt-md-10">
        <v-col cols="12" md="6" class="px-md-10 text-center">
          ...
          <v-img v-if="birds.images.gallery.length==0" :src="birds.images.main" class="hidden-sm-and-down"></v-img>
          <v-carousel v-else cycle height="400" class="rounded-sm" hide-delimiters :show-arrows="false" :class="birds.images.gallery.length<=1 ? 'hidden-sm-and-down' : ''">
            <v-carousel-item
